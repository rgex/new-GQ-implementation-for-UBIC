...
NtpRskSignatureVerificationObject* NtpRsk::signWithNtpRsk(NtpRskSignatureRequestObject *ntpRskSignatureRequestObject) {
    ...
    if(version == 6) {
        ...
        std::cout << "signWithNtpRsk:" << std::endl;
        ...
        std::cout << "T1: " << BN_bn2hex(T1) << std::endl;

        // T2 = r2^e
        BIGNUM *T2 = BN_new();
        BN_mod_exp(T2, r2, e, n, ctx);
        std::cout << "T2: " << BN_bn2hex(T2) << std::endl;
        ...
        std::cout << "T4: " << BN_bn2hex(T4) << std::endl;

        // T1 = r5^e
        BIGNUM *T5 = BN_new();
        BN_mod_exp(T5, r5, e, n, ctx);
        std::cout << "T5: " << BN_bn2hex(T5) << std::endl;

        // T1 = r6^e
        BIGNUM *T6 = BN_new();
        BN_mod_exp(T6, r6, e, n, ctx);
        std::cout << "T6: " << BN_bn2hex(T6) << std::endl;

        // T1 = r7^e
        BIGNUM *T7 = BN_new();
        BN_mod_exp(T7, r7, e, n, ctx);
        std::cout << "T7: " << BN_bn2hex(T7) << std::endl;

        // T8 = r8^e
        BIGNUM *T8 = BN_new();
        BN_mod_exp(T8, r8, e, n, ctx);
        std::cout << "T8: " << BN_bn2hex(T8) << std::endl;

        //Step 2.
        std::vector<unsigned char> toHash = std::vector<unsigned char>();
        toHash = concatCharVector(BN_bn2hex(T1), "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T2));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T3));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T4));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T5));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T6));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T7));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, BN_bn2hex(T8));
        toHash = concatCharVector(toHash, "|");
        toHash = concatCharVector(toHash, Hexdump::vectorToHexString(
                ntpRskSignatureRequestObject->getNm()
                ).c_str()
        );
        std::cout << "toHash: " << toHash.data() << std::endl;

        std::vector<unsigned char> randomOracleHash = Sha256::sha256(toHash);
        std::cout << "randomOracleHash: " << Hexdump::vectorToHexString(randomOracleHash) << std::endl;
        ...
        std::cout << "d1: " << BN_bn2hex(d1) << std::endl;
        std::cout << "d2: " << BN_bn2hex(d2) << std::endl;
        std::cout << "d3: " << BN_bn2hex(d3) << std::endl;
        std::cout << "d4: " << BN_bn2hex(d4) << std::endl;
        std::cout << "d5: " << BN_bn2hex(d5) << std::endl;
        std::cout << "d6: " << BN_bn2hex(d6) << std::endl;
        std::cout << "d7: " << BN_bn2hex(d7) << std::endl;
        std::cout << "d8: " << BN_bn2hex(d8) << std::endl;
        ...
        ntpRskSignatureVerificationObject->setM2(randomOracleHash);
        ...
        ntpRskSignatureVerificationObject->setNmVector(ntpRskSignatureRequestObject->getNm());
...
bool NtpRsk::verifyNtpRsk(NtpRskSignatureVerificationObject *ntpRskSignatureVerificationObject) {
    ...
    if(version == 6) {
        std::cout << "verifyNtpRsk:" << std::endl;
        ...
        // Step 1.
        std::string hashString = Hexdump::vectorToHexString(ntpRskSignatureVerificationObject->getM2());
        ...
        std::cout << "te1: " << BN_bn2hex(te1) << std::endl;
        std::cout << "te2: " << BN_bn2hex(te2) << std::endl;
        std::cout << "te3: " << BN_bn2hex(te3) << std::endl;
        std::cout << "te4: " << BN_bn2hex(te4) << std::endl;
        std::cout << "te5: " << BN_bn2hex(te5) << std::endl;
        std::cout << "te6: " << BN_bn2hex(te6) << std::endl;
        std::cout << "te7: " << BN_bn2hex(te7) << std::endl;
        std::cout << "te8: " << BN_bn2hex(te8) << std::endl;
        ...
        std::cout << "md1: " << BN_bn2hex(md1) << std::endl;
        std::cout << "md2: " << BN_bn2hex(md2) << std::endl;
        std::cout << "md3: " << BN_bn2hex(md3) << std::endl;
        std::cout << "md4: " << BN_bn2hex(md4) << std::endl;
        std::cout << "md5: " << BN_bn2hex(md5) << std::endl;
        std::cout << "md6: " << BN_bn2hex(md6) << std::endl;
        std::cout << "md7: " << BN_bn2hex(md7) << std::endl;
        std::cout << "md8: " << BN_bn2hex(md8) << std::endl;
        ...
        return randomOracleHash == ntpRskSignatureVerificationObject->getM2();
...
std::vector<unsigned char> NtpRsk::concatCharVector(std::vector<unsigned char> elem1, std::vector<unsigned char> elem2) {
    elem1.insert(elem1.end(), elem2.begin(), elem2.end());
    return elem1;
}

std::vector<unsigned char> NtpRsk::concatCharVector(std::vector<unsigned char> elem1, const char* elem2) {
    std::vector<unsigned char> np(elem2, elem2 + strlen(elem2));
    elem1.insert(elem1.end(), np.begin(), np.end());
    return elem1;
}

std::vector<unsigned char> NtpRsk::concatCharVector(const char* elem1, const char* elem2) {
